...
fn test_alu_add_operations() {
    ...
    h.cpu.hart.regs.write(10, 5);
    h.cpu.hart.regs.write(11, 3);
    h.execute_inst(InstructionBuilder::add(12, 10, 11));
    assert_eq!(h.cpu.hart.regs.read(12), 8);

    // Test negative numbers
    h.cpu.hart.regs.write(10, (-5i64) as u64);
    h.cpu.hart.regs.write(11, 3);
    h.execute_inst(InstructionBuilder::add(12, 10, 11));
    assert_eq!(h.cpu.hart.regs.read(12) as i64, -2);
}
...
fn test_alu_sub_operations() {
    ...
    h.cpu.hart.regs.write(10, 10);
    h.cpu.hart.regs.write(11, 3);
    h.execute_inst(InstructionBuilder::sub(12, 10, 11));
    assert_eq!(h.cpu.hart.regs.read(12), 7);

    // Test underflow
    h.cpu.hart.regs.write(10, 3);
    h.cpu.hart.regs.write(11, 10);
    h.execute_inst(InstructionBuilder::sub(12, 10, 11));
    assert_eq!(h.cpu.hart.regs.read(12) as i64, -7);
}
...
fn test_alu_logical_operations() {
    ...
    // AND
    h.cpu.hart.regs.write(10, 0xFF);
    h.cpu.hart.regs.write(11, 0x0F);
    h.execute_inst(InstructionBuilder::and(12, 10, 11));
    assert_eq!(h.cpu.hart.regs.read(12), 0x0F);

    // OR
    h.cpu.hart.regs.write(10, 0xF0);
    h.cpu.hart.regs.write(11, 0x0F);
    h.execute_inst(InstructionBuilder::or(12, 10, 11));
    assert_eq!(h.cpu.hart.regs.read(12), 0xFF);

    // XOR
    h.cpu.hart.regs.write(10, 0xFF);
    h.cpu.hart.regs.write(11, 0x0F);
    h.execute_inst(InstructionBuilder::xor(12, 10, 11));
    assert_eq!(h.cpu.hart.regs.read(12), 0xF0);
}
...
fn test_alu_shift_left() {
    ...
    h.cpu.hart.regs.write(10, 1);
    h.cpu.hart.regs.write(11, 4);
    h.execute_inst(InstructionBuilder::sll(12, 10, 11));
    assert_eq!(h.cpu.hart.regs.read(12), 16);

    // Shift by 0
    h.cpu.hart.regs.write(10, 0xFF);
    h.cpu.hart.regs.write(11, 0);
    h.execute_inst(InstructionBuilder::sll(12, 10, 11));
    assert_eq!(h.cpu.hart.regs.read(12), 0xFF);
}
...
fn test_alu_shift_right_arithmetic() {
    ...
    h.cpu.hart.regs.write(11, 1);
    h.execute_inst(InstructionBuilder::sra(12, 10, 11));
    assert_eq!(h.cpu.hart.regs.read(12), 0xC000_0000_0000_0000);
}
...
fn test_alu_slt_signed() {
    ...
    // Positive >= Positive
    h.cpu.hart.regs.write(10, 10);
    h.cpu.hart.regs.write(11, 5);
    h.execute_inst(InstructionBuilder::slt(12, 10, 11));
    assert_eq!(h.cpu.hart.regs.read(12), 0);
...
fn test_alu_sltu_unsigned() {
    ...
    h.cpu.hart.regs.write(10, 0xFFFF_FFFF_FFFF_FFFF);
    h.cpu.hart.regs.write(11, 5);
    h.execute_inst(InstructionBuilder::sltu(12, 10, 11));
    assert_eq!(h.cpu.hart.regs.read(12), 0); // Max unsigned is not less than 5
}
...
fn test_alu_immediate_operations() {
    ...
    assert_eq!(h.cpu.hart.regs.read(12), 15);
...
fn test_alu_32bit_operations() {
    ...
    // ADDW
    h.cpu.hart.regs.write(10, 0xFFFF_FFFF);
    h.cpu.hart.regs.write(11, 1);
    h.execute_inst(InstructionBuilder::addw(12, 10, 11));
    assert_eq!(h.cpu.hart.regs.read(12) as i64, 0); // Wraps to 0, sign-extended

    // SUBW
    h.cpu.hart.regs.write(10, 1);
    h.cpu.hart.regs.write(11, 2);
    h.execute_inst(InstructionBuilder::subw(12, 10, 11));
    assert_eq!(h.cpu.hart.regs.read(12), 0xFFFF_FFFF_FFFF_FFFF); // -1 sign-extended
}
...
fn test_alu_shift_immediate() {
    ...
    assert_eq!(h.cpu.hart.regs.read(12), 32);

    // SRLI
    h.cpu.hart.regs.write(10, 32);
    ...
    assert_eq!(h.cpu.hart.regs.read(12), 0xF800_0000_0000_0000);
}
...
fn test_alu_zero_register_preserved() {
    ...
    // Try to write to x0
    h.cpu.hart.regs.write(10, 42);
    h.execute_inst(InstructionBuilder::add(0, 10, 10));
    assert_eq!(h.cpu.hart.regs.read(0), 0); // x0 must always be 0
}
...
fn test_multiply_operations() {
    ...
    // MUL
    h.cpu.hart.regs.write(10, 6);
    h.cpu.hart.regs.write(11, 7);
    h.execute_inst(InstructionBuilder::mul(12, 10, 11));
    assert_eq!(h.cpu.hart.regs.read(12), 42);

    // MULW
    h.cpu.hart.regs.write(10, 1000);
    h.cpu.hart.regs.write(11, 1000);
    h.execute_inst(InstructionBuilder::mulw(12, 10, 11));
    assert_eq!(h.cpu.hart.regs.read(12) as i32, 1_000_000);
}
...
fn test_divide_operations() {
    ...
    // DIV
    h.cpu.hart.regs.write(10, 42);
    h.cpu.hart.regs.write(11, 6);
    h.execute_inst(InstructionBuilder::div(12, 10, 11));
    assert_eq!(h.cpu.hart.regs.read(12), 7);

    // DIVU
    h.cpu.hart.regs.write(10, 100);
    h.cpu.hart.regs.write(11, 10);
    h.execute_inst(InstructionBuilder::divu(12, 10, 11));
    assert_eq!(h.cpu.hart.regs.read(12), 10);

    // REM
    h.cpu.hart.regs.write(10, 43);
    h.cpu.hart.regs.write(11, 6);
    h.execute_inst(InstructionBuilder::rem(12, 10, 11));
    assert_eq!(h.cpu.hart.regs.read(12), 1);

    // REMU
    h.cpu.hart.regs.write(10, 101);
    h.cpu.hart.regs.write(11, 10);
...
fn test_divide_by_zero() {
    ...
    h.cpu.hart.regs.write(11, 0);
    h.execute_inst(InstructionBuilder::div(12, 10, 11));
    assert_eq!(h.cpu.hart.regs.read(12), u64::MAX); // -1
}

#[test]
fn test_branch_not_taken() {
    let mut h = TestHarness::boot_default();
    let initial_pc = h.cpu.hart.pc;
    ...
    assert_eq!(h.cpu.hart.pc, initial_pc + 4);
}
...
fn test_branch_taken() {
    ...
    // PC should branch
    assert_eq!(h.cpu.hart.pc, initial_pc + 8);
}
...
fn test_bne_branch() {
    ...
    assert_eq!(h.cpu.hart.pc, initial_pc + 8); // Should branch
}
...
fn test_blt_branch() {
    ...
    assert_eq!(h.cpu.hart.pc, initial_pc + 8); // Should branch (5 < 10)
}
...
fn test_bge_branch() {
    ...
    assert_eq!(h.cpu.hart.pc, initial_pc + 8); // Should branch (10 >= 5)
}
...
fn test_bgeu_branch() {
    ...
    assert_eq!(h.cpu.hart.pc, initial_pc + 8); // Should branch (equal)
}
